      ...
      <div className="w-full">
        ...
        <div className="flex justify-center mt-[10px] px-[5px] md:px-[0px]">
          <div className="grid grid-cols-3 grid-rows-2 gap-2 md:gap-4 ">
              ...
              {places.map((place => 
                <div className=" w-[120px] md:w-[278px]">
        ...
        <div className="flex justify-center items-center">
          <button className=" flex justify-center bg-black text-orange-400 font-bold rounded-2xl px-6 py-4 mt-4 hover:bg-slate-800">
            Explore More<span><img src={right_arrow} className="size-6 ml-[6px]"/></span>
          </button>
        </div>
      </div>
    </>
